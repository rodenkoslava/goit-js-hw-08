...
u=setTimeout(h,t),v(l))}return void 0===u&&(u=setTimeout(h,t)),f}return t=j(t)||0,b(n)&&(s=!!n.leading,a=(d="maxWait"in n)?p(j(n.maxWait)||0,t):a,m="trailing"in n?!!n.trailing:m),T.cancel=function(){void 0!==u&&clearTimeout(u),c=0,i=l=r=u=void 0},T.flush=function(){return void 0===u?f:O(y())},T}(e,t,{leading:i,maxWait:t,trailing:r})};let S=document.querySelector(".feedback-form"),h=document.querySelector('[name="email"]'),O=document.querySelector('[name="message"]'),T={};S.addEventListener("input",((t=i)&&t.__esModule?t.default:t)(function(){T={email:h.value,message:O.value},localStorage.setItem("feedback-form-state",JSON.stringify(T))},500)),(e=JSON.parse(localStorage.getItem("feedback-form-state")))&&(h.value=e.email,O.value=e.message),T=e,S.addEventListener("submit",function(e){e.preventDefault(),""!==h.value.trim()&&""!==O.value.trim()&&(console.log(T),S.reset(),localStorage.removeItem("feedback-form-state"))})}();//# sourceMappingURL=03-feedback.06174b01.js.map

//# sourceMappingURL=03-feedback.06174b01.js.map
